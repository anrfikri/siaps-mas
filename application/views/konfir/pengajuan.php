...
<html lang="en">
    <head>
        ...
        <title>Pengajuan Pembebasan Biaya Rawat Inap / Jalan</title>
 ...
 <main>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-clipboard-check"></div> Data Pengajuan Pembebasan Biaya Rawat Inap / Jalan Anda Telah Kami Terima !
        </div>
          <div class="card-body">
          <p class="lead">Terima Kasih, Pengajuan Pembebasan Biaya Rawat Inap/Jalan akan Kami proses dan dapat diambil di Kantor Dinas Sosial Kabupaten Kudus pada hari kerja :</p>
          <dt >Senin - Kamis (07.00 WIB - 14.00 WIB) dan</dt>
          <dt >Jumat (07.00 WIB - 11.00 WIB)</dt>
          <p class="lead mt-3">Untuk Pengambilan Rekom Mohon membawa BERKAS ASLI. Foto rumah di print berwarna satu lembar hvs.  Dimasukkan dalam plastik terbungkus dan dimasukkan dalam box yang sudah disediakan.</p>
          ...
          <a class="lead mt-1" href="https://wa.me/6282324128050">https://wa.me/6282324128050</a>
