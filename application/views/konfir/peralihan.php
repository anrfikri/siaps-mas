...
<html lang="en">
    <head>
        ...
        <title>Peralihan BPJS Mandiri Kelas 3 ke PBI JKN KIS APBD </title>
 ...
 <main>
       ...
       <div class="container-fluid">
        <h1 class="mt-4">Selamat ! </h1>
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-clipboard-check"></div> Data Peralihan BPJS Mandiri Kelas 3 ke PBI JKN KIS APBD Anda Telah Kami Terima !
        </div>
          <div class="card-body">
          <p class="lead">Terima Kasih, Pengajuan Peralihan BPJS Mandiri Kelas 3 ke PBI JKN KIS APBD  akan Kami proses.</p>
          <p class="lead">Selama proses pengusulan, BPJS Mandiri HARUS TERUS DIBAYAR.</p>
          <p class="lead mt-3">Untuk Pengajuan Peralihan BPJS Mandiri Kelas 3 ke PBI JKN KIS APBD, Mohon mengumpulkan Berkas asli dan foto rumah di print berwarna satu lembar hvs. </p>
          <p class="lead">Dimasukkan dalam plastik terbungkus dimasukkan dalam box yang sudah disediakan pada jam 13.00 WIB Di Dinas Sosial P3AP2KB Kudus.</p>
          <p class="lead mt-3">Untuk Info lebih lanjut dapat menghubungi ke no whatsapp : 082324128050</p>
          <p class="lead mt-1">Atau klik link berikut :</p>
          <a class="lead mt-1" href="https://wa.me/6282324128050">wa.me/6282324128050</a>
        <div class="form-group mt-5">
            <div class="modal-footer">
            <a class="btn btn-secondary" href="<?= base_url('welcome/index'); ?>">Tekan Untuk Lanjut</a>
          </div>
        </div>
