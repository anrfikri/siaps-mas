...
<html lang="en">
    <head>
        ...
        <title>Form Pengaduan Bansos PKH</title>
 ...
 <main>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-clipboard-check"></div> Data Pengaduan Bansos PKH Anda Telah Kami Terima !
        </div>
          <div class="card-body">
          <p class="lead mt-3">Untuk Info lebih lanjut mengenai Program PKH dapat menghubungi ke no whatsapp : 081325483593</p>
          <p class="lead mt-1">Atau klik link berikut :</p>
          <a class="lead mt-1" href="https://wa.me/6281325483593">https://wa.me/6281325483593</a>
