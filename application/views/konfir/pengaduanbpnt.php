...
<html lang="en">
    <head>
        ...
        <title>Form Pengaduan Bansos Pangan Sembako / BPNT</title>
 ...
 <main>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-clipboard-check"></div> Data Pengaduan Bansos Pangan Sembako / BPNT Anda Telah Kami Terima !
        </div>
          <div class="card-body">
          <p class="lead">Untuk Info lebih lanjut mengenai Program Bansos Pangan Sembako / BPNT silahkan sampaikan ke :</p>
          <a class="lead" href="http://sembara.kuduskab.go.id">http://sembara.kuduskab.go.id</a>
