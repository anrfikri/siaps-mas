...
<html lang="en">
    <head>
        ...
        <title>Pengajuan Surat Keterangan DTKS untuk Rekomendasi KIP</title>
 ...
 <main>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-clipboard-check"></div> Data Pengajuan Surat Keterangan DTKS untuk Rekomendasi KIP Anda Telah Kami Terima !
        </div>
          <div class="card-body">
          <p class="lead">Terima Kasih, Pengajuan Surat Keterangan DTKS untuk Rekomendasi KIP akan Kami proses dan dapat diambil di Kantor Dinas Sosial Kabupaten Kudus pada hari kerja :</p>
          <dt >Senin - Kamis (07.00 WIB - 14.00 WIB) dan</dt>
          <dt >Jumat (07.00 WIB - 11.00 WIB)</dt>
          <p class="lead mt-3">Untuk pengambilan Surat DTKS mohon mengumpulkan berkas di masukkan dalam plastik terbungkus dimasukkan dalam box yang sudah di siapkan.</p>
