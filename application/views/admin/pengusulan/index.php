<div class="container-fluid">
    <h1 class="mt-4">Manajemen Data Pengusulan PBI JKN KIS APBD</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
        <li class="breadcrumb-item active">Data Pengusulan PBI JKN KIS APBD</li>
    </ol>
    <div class="card mb-4">
      <div class="card-header">
        <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#formModalPengusulan">
        <div class="fas fa-plus"></div> Tambah Data Pengusulan
      </button>

      <div class="flash-data" data-flashdata="<?= $this->session->flashdata('pengusulan');?>"></div>
      </div>
        <div class="card-body">
            <table class="table table-bordered responsive display nowrap" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php $no = 1; foreach($pengusulan as $u) : ?>
                  <tr>
                    <td><?= $no++; ?></td>
                    ...
                    <td><?= $u['kecamatan']; ?></td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['sktm']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['ktp']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['kk']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['depan']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['tamu']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['kamar']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['dapur']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pengusulan/<?= $u['wc']; ?>" width="100">
                    </td>
                    <td>
                      <!-- <a href="<?= base_url('admin/pengusulan/printsurat/') . $u['id_pengusulan']; ?>" class="btn btn-success"><i class="fas fa-print"></i></a> -->
                      <a href="<?= base_url('admin/pengusulan/ubah/') . $u['id_pengusulan']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                      <a href="<?= base_url('admin/pengusulan/hapus/') . $u['id_pengusulan']; ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
...
<!-- Modal -->
<div class="modal fade" id="formModalPengusulan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabelPengusulan">Tambah Data pengusulan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
     
      <div class="modal-body">
        <div class="modal-body">
        <?= form_open_multipart('admin/pengusulan/add'); ?>
        <input type="hidden" name="id_pengusulan" id="id_pengusulan">
        ...
        <div class="form-group mt-3">
          <label for="sktm">Upload Foto/Scan SKTM perihal Pengajuan Pengusulan PBI JKN KIS APBD  dari Desa Mengetahui Kecamatan stempel basah/Asli (format .jpg/.jpeg/.pdf) *</label>
