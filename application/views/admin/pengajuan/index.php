<div class="container-fluid">
    <h1 class="mt-4">Manajemen Data Pengajuan Pembebasan Biaya Rawat Inap / Jalan</h1>
    ...
    <div class="card mb-4">
      <div class="card-header">
        <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#formModalPengajuan">
        <div class="fas fa-plus"></div> Tambah Data Pengajuan
      </button>

      <div class="flash-data" data-flashdata="<?= $this->session->flashdata('pengajuan');?>"></div>
      </div>
        <div class="card-body">
            <table class="table table-bordered responsive display nowrap" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php $no = 1; foreach($pengajuan as $u) : ?>
                  <tr>
                    <td><?= $no++; ?></td>
                    ...
                    <td><?= $u['whatsapp']; ?></td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['sktm']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['ktp']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['kk']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['surat_rawat']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['depan']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['tamu']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['kamar']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['dapur']; ?>" width="100">
                    </td>
                    <td>
                      <img src="<?= base_url();?>assets/image/pembebasan/<?= $u['wc']; ?>" width="100">
                    </td>
                    <td>
                      <a href="<?= base_url('admin/pengajuan/printsurat/') . $u['id_pengajuan']; ?>" class="btn btn-success"><i class="fas fa-print"></i></a>
                      <a href="<?= base_url('admin/pengajuan/ubah/') . $u['id_pengajuan']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                      <a href="<?= base_url('admin/pengajuan/hapus/') . $u['id_pengajuan']; ?>" class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
...
<!-- Modal -->
<div class="modal fade" id="formModalPengajuan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabelPengajuan">Tambah Data Pengajuan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
     
      <div class="modal-body">
        <div class="modal-body">
        <?= form_open_multipart('admin/pengajuan/add'); ?>
        ...
        <div class="form-group mt-3">
          <label for="whatsapp">No whatsapp yang bisa dihubungi *</label>
          <input type="text" name="whatsapp" id="whatsapp" class="form-control" placeholder="Masukkan No Whatsapp" required>
        </div>
        <div class="form-group mt-3">
          <label for="sktm">Upload Foto/Scan SKTM perihal Pembebasan Biaya Rawat Inap/Jalan dari Desa Mengetahui Kecamatan stempel basah/Asli (format .jpg/.jpeg/.pdf) *</label>
        ...
        <div class="form-group mt-3">
          <label for="rawat">Upload Foto/Scan Surat Rawat (format .jpg/.jpeg/.pdf) *</label>
          <input type="file" name="rawat" id="rawat" class="form-control"required>
        </div>
        <div class="form-group mt-3">
