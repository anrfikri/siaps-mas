...
<html lang="en">
 ...
 <main>
    ...
    <h1 class="mt-4">Pengajuan Peralihan BPJS Mandiri Kelas 3 ke PBI JKN KIS APBD </h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active"><a>Mohon isi form dengan jujur dan sebenar-benarnya!</a></li>
    </ol>
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-edit"></div> Form Pengajuan Peralihan BPJS Mandiri Kelas 3 ke PBI JKN KIS APBD 
        </div>
          <?= form_open_multipart('awal/peralihan/add'); ?>
          <div class="card-body">
          <input type="hidden" name="id_peralihan" class="form-control" >
