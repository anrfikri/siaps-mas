...
<html lang="en">
 ...
 <main>
    ...
    <h1 class="mt-4"> Pengaduan Bansos Pangan Sembako / BPNT</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active"><a>Pengaduan Bansos Pangan Sembako / BPNT</a></li>
    </ol>
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-edit"></div> Form Pengaduan Bansos Pangan Sembako / BPNT
        </div>
          <?= form_open_multipart('awal/pengaduanbpnt/add'); ?>
          <div class="card-body">
          <input type="hidden" name="id_pengaduanbpnt" class="form-control" >
