...
<html lang="en">
 ...
 <main>
    ...
    <h1 class="mt-4">Pengajuan Reaktifasi PBI JKN KIS APBN </h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active"><a>Mohon isi form dengan sebenar-benarnya!</a></li>
    </ol>
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-edit"></div> Form Pengajuan Reaktifasi PBI JKN KIS APBN 
        </div>
          <?= form_open_multipart('awal/reaktifasi/add'); ?>
          <div class="card-body">
          <input type="hidden" name="id_reaktifasi" class="form-control" >
