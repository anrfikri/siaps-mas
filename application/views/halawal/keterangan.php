...
<html lang="en">
 ...
 <main>
    ...
    <h1 class="mt-4">Pengajuan Surat Keterangan DTKS untuk Rekomendasi KIP </h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active"><a>Mohon isi form dengan jujur dan sebenar-benarnya!</a></li>
    </ol>
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-edit"></div> Form Pengajuan Surat Keterangan DTKS untuk Rekomendasi KIP 
        </div>
          <?= form_open_multipart('awal/keterangan/add'); ?>
          <div class="card-body">
          <input type="hidden" name="id_keterangan" class="form-control" >
