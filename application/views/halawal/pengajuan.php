...
<html lang="en">
 ...
 <main>
    ...
    <h1 class="mt-4">Pengajuan Pembebasan Biaya Rawat Inap/Jalan</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active"><a>Mohon isi form dengan jujur dan sebenar-benarnya!</a></li>
    </ol>
    <div class="card mb-4">
        <div class="card-header">
            <div class="fas fa-edit"></div> Form Pengajuan Pembebasan Biaya Rawat Inap/Jalan
        </div>
          <?= form_open_multipart('awal/pengajuan/add'); ?>
          <div class="card-body">
          <input type="hidden" name="id_pengajuan" class="form-control">
